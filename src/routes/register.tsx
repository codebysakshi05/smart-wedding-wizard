...
function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Account created! Welcome to Smart Wedding Wizard.");
      navigate({ to: "/plan" });
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-white/75 text-sm">Join us to start planning your dream wedding.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            <span className="relative">{isLoading ? "Registering..." : "Create Account"}</span>
